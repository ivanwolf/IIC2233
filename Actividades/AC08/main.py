    ...
    def revisar(func):
        ...
        def _tipar(*tipos):
            ...
            if isinstance(tipos[0], int):
                if not isinstance(tipos[1], int):
                    return 'Argumentos malos'

            elif isinstance(tipos[0], str):
                if not isinstance(tipos[1], str):
                    return 'Argumentos malos'

            elif isinstance(tipos[0], list):
                if not isinstance(tipos[1], list):
                    return 'Argumentos malos'
                if not isinstance(tipos[2], tuple):
                    return 'Argumentos malos'
